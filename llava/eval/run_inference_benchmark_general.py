    ...
    for sample in tqdm(gt_contents):
        ...
        for fmt in video_formats:  # Added this line
            ...
            if os.path.exists(temp_path):
                ...
                # video_frames = load_video_key_frames(video_path, num_frm=args.num_frames, key_idx=keyframe_indexs[id])
                # video_frames = load_video_uniform_key_frames(video_path, num_frm=args.num_frames, key_idx=keyframe_indexs[id])
